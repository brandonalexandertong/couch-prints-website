...
export default function doThree () {
  ...
  const tellU = createTellU("lib/impressions-art.jpg", 0, 0, -1000, "http://fn-up.com/", "www.fn-up.com")
  ...
  const animate = function () {
    ...
    const currentX = currentX + diffX * 0.1
    const currentY = currentY + diffY * 0.1
    const currentX2 = currentX + diffX2 * 0.1
    const currentY2 = currentY + diffY2 * 0.1
